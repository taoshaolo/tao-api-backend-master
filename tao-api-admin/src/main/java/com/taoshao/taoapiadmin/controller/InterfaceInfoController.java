package com.taoshao.taoapiadmin.controller;

import cn.hutool.json.JSONUtil;
import com.taoshao.taoapiadmin.annotation.AuthCheck;
import com.taoshao.taoapiadmin.config.GatewayConfig;
import com.taoshao.taoapiadmin.exception.BusinessException;
import com.taoshao.taoapiadmin.exception.ThrowUtils;
import com.taoshao.taoapiadmin.service.InterfaceInfoService;
import com.taoshao.taoapiadmin.service.UserService;
import com.taoshao.taoapicommon.common.*;
import com.taoshao.taoapicommon.constant.CommonConstant;
import com.taoshao.taoapicommon.constant.UserConstant;
import com.taoshao.taoapicommon.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import com.taoshao.taoapicommon.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
import com.taoshao.taoapicommon.model.dto.interfaceinfo.InterfaceInfoQueryRequest;
import com.taoshao.taoapicommon.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;
import com.taoshao.taoapicommon.model.entity.InterfaceInfo;
import com.taoshao.taoapicommon.model.entity.User;
import com.taoshao.taoapicommon.model.enums.InterfaceInfoStatusEnum;
import com.taoshao.taoapicommon.model.vo.InterfaceInfoVO;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        // 获取SDK客户端
        com.taoshao.taoclientsdk.client.TaoApiClient taoApiClient = interfaceInfoService.getNeroApiClient(request);
        // 设置网关地址
        taoApiClient.setGatewayHost(gatewayConfig.getHost());
        try {
            // 执行方法
            String invokeResult = taoApiClient.invokeInterface(requestParams, url, method);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        try {
            // 执行方法
            invokeResult = taoApiClient.invokeInterface(requestParams, url, method);
            if (StringUtils.isBlank(invokeResult)) {
                throw new BusinessException(ErrorCode.SYSTEM_ERROR, "接口数据为空");
            }
        } catch (Exception e) {
