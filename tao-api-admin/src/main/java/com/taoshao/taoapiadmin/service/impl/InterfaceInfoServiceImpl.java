...
import com.taoshao.taoapiadmin.utils.SqlUtils;
...
import com.taoshao.taoapicommon.model.vo.UserVO;
...
public class InterfaceInfoServiceImpl extends ServiceImpl<InterfaceInfoMapper, InterfaceInfo>
    ...
    @Override
    public com.taoshao.taoclientsdk.client.TaoApiClient getNeroApiClient(HttpServletRequest request) {
        // 获取当前登录用户
        User loginUser = userService.getLoginUser(request);
